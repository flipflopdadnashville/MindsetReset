...
/*    void Start()
    ...
    void CreateShape()
    {
        ...
        for (int i = 0, z =0; z<= zSize; z++)
        {
            ...
            {
                float y = Mathf.PerlinNoise(x * .3f, z * .3f) * Random.Range(2, 4);
    ...
    void PlaceTerrain(){
        this.transform.position = new Vector3(instance.activePlayer.transform.position.x, instance.activePlayer.transform.position.y - 10, instance.activePlayer.transform.position.z);
    }
*/
