...
public class MapGenerator : MonoBehaviour {
	...
	void Start() {
		...
		//Debug.Log("From Map Generator, updated mesh heights with a min height of: " + heightMapSettings.minHeight + " and a max height of: " + heightMapSettings.maxHeight);
	}
	...
	void Update() {
		...
		if(Input.GetKeyDown(KeyCode.K)){
			...
			//Figure out how to generate new terrain
		}
