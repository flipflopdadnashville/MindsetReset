...
public class EndlessTerrain : MonoBehaviour {
	...
	void Start() {
		...
		//Debug.Log("From EndlessTerrain, found Map Generator with name " + mapGenerator.name);

		maxViewDst = detailLevels [detailLevels.Length - 1].visibleDstThreshold;
		//Debug.Log("From EndlessTerrain, maxViewDst is: " + maxViewDst);
		meshWorldSize = mapGenerator.meshSettings.meshWorldSize;
		//Debug.Log("From EndlessTerrain, meshWorldSize is: " + meshWorldSize);
		chunksVisibleInViewDst = Mathf.RoundToInt(maxViewDst / meshWorldSize);
		//Debug.Log("From EndlessTerrain, chunksVisibleInViewDst is: " + chunksVisibleInViewDst);
	...
	void Update() {
		...
		if (viewerPosition != viewerPositionOld) {
			//Debug.Log("From EndlessTerrain, viewer position has changed");
	...
	void UpdateVisibleChunks() {
		//Debug.Log("From Endless Terrain, updating visible chunks...");
