...
public class RippleEffect : MonoBehaviour {
    ...
    void Start(){
        ...
        instance.rippleScaleSlider.onValueChanged.AddListener (delegate {ValueChangeCheck ();});
        instance.rippleSpeedSlider.onValueChanged.AddListener (delegate {ValueChangeCheck ();});
        instance.rippleFrequencySlider.onValueChanged.AddListener (delegate {ValueChangeCheck ();});
        instance.rippleSizeSlider.onValueChanged.AddListener (delegate {ValueChangeCheck ();});
    }

    public void ValueChangeCheck(){
        waveScale = instance.rippleScaleSlider.value;
        waveSpeed = instance.rippleSpeedSlider.value;
        waveFrequency = instance.rippleFrequencySlider.value;
        circleXScale = instance.rippleSizeSlider.value;
        circleYScale = instance.rippleSizeSlider.value;
    }
    ...
    Vector2 ConvertToTextureSpace(Vector2 value) {
        ...
        //JWR changing because of our weird camera setup
