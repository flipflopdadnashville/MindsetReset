...
public class AIPath : MonoBehaviour {
    ...
    void Update(){
        goArray = GameObject.FindGameObjectsWithTag("object");
        if(goArray.Length == 10 || goArray.Length == 20){
            Debug.Log("goArray length is 20");
            foreach(GameObject i in goArray){
                Debug.Log("Adding game object: " + i);
                nodes.Add(i);
                Debug.Log("nodes count is now: " + nodes.Count);
            }
