...
namespace LLMUnitySamples
{
    public class ChatBot : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            inputBubble = new InputBubble(chatContainer, playerUI, "InputBubble", "Gathering my thoughts. Give me a few seconds, please...", 4);
        ...
        {
            warmUpDone = true;
            inputBubble.SetPlaceHolderText("Enter text here, or press escape to return home...");
            AllowInput();
        }
        ...
        void Update()
        {
            ...
            {
                SceneManager.UnloadSceneAsync("AffirmationBot");
            }
        }
