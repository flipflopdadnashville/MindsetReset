...
public class FishingPolePhysics : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(newPoleRot.x > -.55){
            ...
            {
                pole.transform.Rotate(-3f, 0, 0);
                bendablePole.GetComponent<MegaBend>().angle -= 1f;
                bendablePole.GetComponent<MegaBend>().dir += Random.Range(-1f,1.1f);
            }
        }
        ...
        if(Input.GetMouseButtonUp(0))
		{
            ...
            if(fish.transform.position.x < 0){
                bendablePole.GetComponent<MegaBend>().angle = Random.Range(30, 45);
            }
